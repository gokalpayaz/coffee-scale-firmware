...
class BrewConfigTests(unittest.TestCase):
    def test_agreed_defaults(self):
        ...
        self.assertEqual(350, config.tare_min_wait_ms)
        self.assertEqual(300, config.tare_stable_window_ms)
        self.assertEqual(0.2, config.tare_stable_max_span_g)
        self.assertEqual(2000, config.tare_timeout_ms)
